...
12. ［データソースフィルターの編集］ダイアログで、［追加］をクリックします。    13. ［国］をクリックし、［OK］をクリックします。    
14. ［フィルター］ダイアログの右下にある［除外］にチェックを入れます。    
15. 「NULL」と「計」がつくものと「総計」をチェックして、［Enter］キーを押します。          
16. ［OK］をクリックして画面を閉じます。  続けて［OK］をクリックして画面を閉じます。        
17. ［シート］に移動して、表を参考にビューを作成します。      

［行］	［年］    
［マーク］カードの［色］	［国］    
［マーク］カードの［サイズ］	［合計（人数）］  

18. ツールバーから［標準］→［ビュー全体］や［幅を合わせる］をクリックします。    
